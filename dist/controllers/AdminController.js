...
var CreateVendor = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, ownerName, foodType, pincode, address, phone, email, password, existingVendor, salt, userPassword, createVendor;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, res.json({ "message": "Vendor is not available" })];
        }
    });
}); };
